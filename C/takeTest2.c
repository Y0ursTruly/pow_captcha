...
int main(int argc, char **argv){
    int i;
    unsigned char test[124]={0, 255, 0, 6, 0, 36, 185, 186, 0, 23, 87, 118, 0, 32, 72, 103, 0, 19, 49, 112, 0, 43, 148, 151, 0, 35, 124, 125, 21, 63, 154, 32, 209, 37, 175, 231, 23, 174, 213, 110, 38, 202, 85, 155, 232, 134, 182, 10, 36, 15, 133, 65, 63, 74, 234, 241, 146, 181, 214, 158, 153, 194, 117, 108, 153, 15, 17, 102, 206, 51, 67, 150, 143, 251, 15, 81, 26, 72, 249, 80, 245, 196, 82, 102, 145, 179, 154, 110, 31, 223, 54, 253, 87, 199, 12, 124, 185, 95, 12, 204, 163, 155, 169, 149, 117, 87, 168, 98, 169, 78, 230, 226, 63, 152, 157, 176, 26, 250, 193, 21, 103, 216, 56, 70};
    unsigned char solution[64]={153, 194, 117, 108, 153, 15, 17, 102, 206, 51, 67, 150, 143, 251, 15, 81, 26, 72, 249, 53, 245, 196, 82, 101, 145, 179, 154, 110, 31, 223, 54, 253, 82, 199, 12, 124, 185, 95, 12, 204, 163, 155, 169, 150, 117, 87, 168, 98, 169, 78, 230, 226, 63, 152, 157, 176, 26, 250, 193, 21, 103, 216, 56, 70};
    
    gettimeofday(&start_time,NULL);
    String *answer=takeTest(makeString(test,124));
    for(i=0;i<64;i++){
        if(answer->str[i]!=solution[i]){
            printf("wrong\n");
            exit(1);
        }
    }
    gettimeofday(&stop_time,NULL);
    unsigned long long elapsed=(stop_time.tv_sec-start_time.tv_sec)*1000000+(stop_time.tv_usec-start_time.tv_usec);
